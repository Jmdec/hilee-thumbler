  ...
  if (loading) {
    return (
      <SidebarProvider defaultOpen={!isMobile}>
        <div className="flex min-h-screen w-full bg-gradient-to-br from-purple-50 to-purple-50">
          <AppSidebar />
          ...
          <div className={`flex-1 min-w-0 ${isMobile ? "ml-0" : "ml-72"}`}>
            <div className="flex items-center justify-center min-h-screen w-full">
              <div className="text-center bg-white/80 backdrop-blur-sm p-8 rounded-xl shadow-lg max-w-md">
                <h2 className="text-2xl font-bold text-purple-800 mb-4">Failed to load analytics</h2>
                <p className="text-purple-600 mb-4">{error || "No data available"}</p>
        ...
        <div className={`flex-1 min-w-0 ${isMobile ? "ml-0" : "ml-72"}`}>
          {isMobile && (
            <div className="sticky top-0 z-50 flex h-12 items-center gap-2 border-b bg-white/90 backdrop-blur-sm px-4 md:hidden shadow-sm">
              ...
              <span className="text-sm font-semibold bg-gradient-to-r from-purple-600 to-purple-600 bg-clip-text text-transparent">
                Dashboard
              </span>
            </div>
          )}
          <main className="flex-1 overflow-auto p-3 sm:p-4 md:p-6">
            <div className="max-w-7xl mx-auto space-y-8">
              <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-purple-100">
                <h1 className="text-2xl sm:text-4xl font-bold bg-gradient-to-r from-purple-600 to-purple-600 bg-clip-text text-transparent mb-2">
                  Admin Dashboard
                </h1>
...
LARAVEL_API_TOKEN=your-sanctum-token-here`}
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <Card className="border-purple-200 bg-gradient-to-br from-purple-500 to-purple-500 text-white shadow-xl">
                    ...
                    <Card className="border-purple-200 bg-gradient-to-br from-purple-600 to-purple-600 text-white shadow-xl">
                      <CardHeader className="pb-2">
                  ...
                  <Card className="border-purple-200 bg-white/70 backdrop-blur-sm shadow-xl">
                    <CardHeader>
                      <CardTitle className="text-purple-800">Revenue Trends</CardTitle>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <Card className="border-purple-200 bg-white/70 backdrop-blur-sm shadow-xl">
                      <CardHeader>
                        <CardTitle className="text-purple-800">Order Status Distribution</CardTitle>
                        <CardDescription className="text-purple-600">Current order status breakdown</CardDescription>
                      </CardHeader>
                      <CardContent>
                    ...
                    <Card className="border-purple-200 bg-white/70 backdrop-blur-sm shadow-xl">
                      <CardHeader>
                        ...
                        <CardDescription className="text-purple-600">Payment method preferences</CardDescription>
                      </CardHeader>
                      <CardContent>
                  ...
                  <Card className="border-purple-200 bg-white/70 backdrop-blur-sm shadow-xl">
                    <CardHeader>
                      <CardTitle className="text-purple-800">Popular Products</CardTitle>
                      <CardDescription className="text-purple-600">Top selling items by order count</CardDescription>
                    </CardHeader>
                    <CardContent>
                      {analytics.popularProducts && analytics.popularProducts.length > 0 ? (
                        <div className="space-y-4">
                          {analytics.popularProducts.map((product, index) => (
                            <div
                              key={product.name}
                              className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-purple-50 rounded-lg border border-purple-200"
                            >
                              <div className="flex items-center space-x-4">
                                <div className="w-8 h-8 bg-gradient-to-br from-purple-500 to-purple-500 text-white rounded-full flex items-center justify-center font-bold">
                                  {index + 1}
                                </div>
                                <div>
                              ...
                              <div className="text-right">
                                <div className="font-bold text-purple-800">{product.orders} orders</div>
                                <div className="text-sm text-purple-600">₱{product.revenue.toLocaleString()}</div>
                              </div>
                            </div>
                          ))}
                        </div>
                  ...
                  <Card className="border-purple-200 bg-white/70 backdrop-blur-sm shadow-xl">
                    <CardHeader>
                      <CardTitle className="text-purple-800">Category Performance</CardTitle>
                      <CardDescription className="text-purple-600">Revenue by product category</CardDescription>
                    </CardHeader>
                    <CardContent>
