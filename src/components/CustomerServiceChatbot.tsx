    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-6 right-6 h-16 w-16 rounded-full shadow-xl bg-gradient-to-r from-purple-500 to-violet-500 hover:from-purple-600 hover:to-violet-600 z-50 transition-all duration-300 hover:scale-110"
          size="icon"
        >
