        ...
        headers: [
          ...
          // 🔒 Content Security Policy - FIXED FOR VIDEO
          {
            ...
            value: [
              ...
              // API connections
              "connect-src 'self' https://infinitech-api10.site http://localhost:8000 https://*.googleapis.com https://*.google.com",
              ...
              "media-src 'self' blob: data: https://infinitech-api10.site http://localhost:8000",
